    ...
    public void RandomDest()
    {
        ...
        switch (randomFloor)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                randomRoom = Random.Range(0, listOfDestination._destination3.Length);
                destination = listOfDestination._destination3[randomRoom];
                break;
            case 4:
                randomRoom = Random.Range(0, listOfDestination._destination4.Length);
                destination = listOfDestination._destination4[randomRoom];
                break;
        }
