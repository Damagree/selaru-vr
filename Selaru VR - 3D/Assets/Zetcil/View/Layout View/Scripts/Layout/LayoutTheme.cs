...
namespace Zetcil
{
    public class LayoutTheme : MonoBehaviour
    {
        ...
        public Toggle PresetDefault;
        public Toggle PresetVermilion;
        public Toggle PresetEmerald;
        public Toggle PresetAzure;
        ...
        public void SaveVermilionTheme()
        {
            PresetType = CPresetType.Vermilion;
            SetLayoutVermilion();
        }

        public void SaveEmeraldTheme()
        {
            PresetType = CPresetType.Emerald;
            SetLayoutEmerald();
        }

        public void SaveAzureTheme()
        {
            PresetType = CPresetType.Azure;
            SetLayoutAzure();
        }

        CPresetType GetPresetType()
        {
            return PresetType;
        }
        ...
        void UpdateThemeStatus()
        {
            ...
            {
                PresetDefault.isOn = true;
            }
            if (PresetType == CPresetType.Vermilion)
            {
                PresetVermilion.isOn = true;
            }
            if (PresetType == CPresetType.Emerald)
            {
                PresetEmerald.isOn = true;
            }
            if (PresetType == CPresetType.Azure)
            {
                PresetAzure.isOn = true;
            }
