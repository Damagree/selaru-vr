...
namespace Zetcil
{
    public class LayoutGraphicView : MonoBehaviour
    {
        ...
        [Header("UI Settings")]
        public Toggle AntiAliasUI;
        public Toggle ReflectionUI;
        public Toggle LightCorrectionUI;
